...
public class AccountLoginPage extends Utility {
    ...
    public String getReturningCustomerText() {
        ...
        CustomListners.test.log(Status.PASS,"Returning Customer Text " + returningCustomerText);
    ...
    public void enterEmailAddress(String email) {
        ...
        CustomListners.test.log(Status.PASS,"Enter EmailId " + emailAddressField);
        sendTextToElement(emailAddressField, email);
    }

    public void enterPassword(String password) {
        Reporter.log("Enter Password " + emailAddressField.toString());
        CustomListners.test.log(Status.PASS,"Enter Password " + emailAddressField);
        sendTextToElement(passwordField, password);
    }

    public void clickOnLoginButton() {
        Reporter.log("Click on login Button " + emailAddressField.toString());
        CustomListners.test.log(Status.PASS,"Click on login Button " + emailAddressField);
