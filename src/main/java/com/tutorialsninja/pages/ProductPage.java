...
public class ProductPage extends Utility {
    ...
    public String getProductText() {
        ...
        CustomListners.test.log(Status.PASS, "get Product Text " + productText);
        return getTextFromElement(productText);
    }

    public void selectDeliveryDate(String day, String month, String year) {
        clickOnElement((WebElement) datePicker);
        while (true) {
    ...
    public void clickOnAddToCartButton() {
        ...
        CustomListners.test.log(Status.PASS, "Click on add to cart button " + addToCartButton);
        clickOnElement(addToCartButton);
    }

    public String getProductAddedSuccessMessage() {
        Reporter.log("get Product Added Success Message  " + successMessage.toString());
        CustomListners.test.log(Status.PASS, "get Product Added Success Message " + successMessage);
    ...
    public void clickOnShoppingCartLinkIntoMessage() {
        ...
        CustomListners.test.log(Status.PASS, "click On Shopping Cart LinkI nto Message " + shoppingCartLink);
        clickOnElement(shoppingCartLink);
    }

    public void enterQuantity(String qty) {
        clearTextOnElement(qtyField);
        sendTextToElement((WebElement) qtyField, qty);
    }
}
