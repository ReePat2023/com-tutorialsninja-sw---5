...
public class MyAccountPage extends Utility {
    ...
    public String getAccountLogoutText() {
        ...
        CustomListners.test.log(Status.PASS, "get Account Logout Text " + accountLogoutText);
    ...
    public String getYourAccountHasBeenCreatedText() {
        ...
        CustomListners.test.log(Status.PASS, "get Your Account Has Been Created Text " + accountCreatedText);
