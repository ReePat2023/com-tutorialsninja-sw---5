...
public class ShoppingCartPage extends Utility {
    ...
    public String getShoppingCartText() {
        ...
        CustomListners.test.log(Status.PASS, "get Shopping Cart Text " + shoppingCartText);
        return getTextFromElement(shoppingCartText);
    }

    public String getProductName() {
        Reporter.log("get ProductName Text  " + productName.toString());
        CustomListners.test.log(Status.PASS, "get ProductName Text  " + productName);
        return getTextFromElement(productName);
    }

    public String getDeliveryDate() {
        Reporter.log("get Delivery Date  " + deliveryDate.toString());
        CustomListners.test.log(Status.PASS, "get Delivery Date   " + deliveryDate);
        return getTextFromElement(deliveryDate);
    }

    public String getModel() {
        Reporter.log("get Model " + model.toString());
        CustomListners.test.log(Status.PASS, "get Model " + model);
        return getTextFromElement(model);
    }

    public String getTotal() {
        Reporter.log("get Total " + total.toString());
        CustomListners.test.log(Status.PASS, "get Total " + total);
        return getTextFromElement(total);
    }

    public void changeQuantity(String qty) {
        Reporter.log("Change Quantity " + qtyField.toString());
        CustomListners.test.log(Status.PASS, "Change Quantity " + qtyField);
        sendTextToElement(qtyField, qty);
    }

    public void clickOnQtyUpdateButton() {
        Reporter.log("click On Qty Update Button " + qtyUpdateBtn.toString());
        CustomListners.test.log(Status.PASS, "click On Qty Update Button " + qtyUpdateBtn);
    ...
    public String getSuccessModifiedMessage() {
        ...
        CustomListners.test.log(Status.PASS, "get Success Modified Message  " + successModifiedMessage);
